...
, platforms ? with stdenv.lib.platforms; unix ++ windows ++ wasm # GHC can cross-compile
, hydraPlatforms ? null
...
let
  ...
  defaultConfigureFlags = [
    ...
    (optionalString (versionOlder "8.4" ghc.version && !hostPlatform.isWasm) (enableFeature enableStaticLibraries "static"))
